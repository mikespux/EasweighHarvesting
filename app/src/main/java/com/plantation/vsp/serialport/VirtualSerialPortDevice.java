...
package com.plantation.vsp.serialport;
...
import com.plantation.vsp.ble.BleBaseDeviceManager;
import com.plantation.vsp.ble.IBleBaseActivityUiCallback;
import com.plantation.vsp.misc.FifoQueue;
...
public class VirtualSerialPortDevice extends BleBaseDeviceManager {
    ...
    private final VirtualSerialPortDeviceCallback mVSPUiDeviceCallback;
     ...
     * the remote device
     *
     * @param data the data to write to the TX buffer and to send to the remote
     *             device
     */
     ...
     *
     * @param found true if VSP service was found, otherwise false
     */
