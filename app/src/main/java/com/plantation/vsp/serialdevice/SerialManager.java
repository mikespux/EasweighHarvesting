...
import com.plantation.vsp.serialport.VirtualSerialPortDevice;


public class SerialManager extends VirtualSerialPortDevice {
    private final SerialManagerUiCallback mSerialManagerUiCallback;
    ...
    public void onVspReceiveData(BluetoothGatt gatt,
        ...
        while (mRxBuffer.read(mRxDest) != 0) {
            ...
            String Reading = mRxDest.substring(3, 9);
