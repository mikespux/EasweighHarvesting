...
public abstract class FileHandling {
     ...
     *
     * @param fileWrapper the fileWrapper object associated with the file you want to
     *                    read
    ...
    public static byte[] readUntilTotalBytesToRead(FileWrapper fileWrapper,
        ...
        try {
            ...
            fileEnd = is.read(bFile, 0, totalBytesToRead);
     ...
     * @param fileWrapper the fileWrapper object associated with the file you want to
     *                    read
     * @param readUntil   the string to read data until it's found
