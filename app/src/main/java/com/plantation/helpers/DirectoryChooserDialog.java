...
public class DirectoryChooserDialog {
    ...
    private String m_sdcardfpDirectory = "";
    ...
    public DirectoryChooserDialog(Context context, String file_select_type, SimpleFileDialogListener SimpleFileDialogListener) {
        ...
        m_sdcardfpDirectory = Environment.getExternalStorageDirectory() + "/" + "/Easyweigh/Fingerprints/";
    ...
    public void choosefpFile_or_Dir() {
        // Initial directory is sdcard directory
        if (m_dir.equals("")) chooseFile_or_Dir(m_sdcardfpDirectory);
        else chooseFile_or_Dir(m_dir);
    }
