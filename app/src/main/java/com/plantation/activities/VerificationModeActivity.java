    ...
    public void initializer() {
        ...
        btn_manualsearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mIntent = new Intent(VerificationModeActivity.this, ScaleEasyWeighActivity.class);
        ...
        btn_cardsearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mIntent = new Intent(VerificationModeActivity.this, ScaleEasyWeighBioActivity.class);
                startActivity(mIntent);
            }
        });
