 ...
 */
public class VerificationModeTaskActivity extends AppCompatActivity {
    ...
    public void initializer() {
        mSharedPrefs = PreferenceManager.getDefaultSharedPreferences(VerificationModeTaskActivity.this);
        prefs = PreferenceManager.getDefaultSharedPreferences(VerificationModeTaskActivity.this);
        ...
        btn_manualsearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mIntent = new Intent(VerificationModeTaskActivity.this, EmployeeBrowserActivity.class);
        ...
        btn_cardsearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mIntent = new Intent(VerificationModeTaskActivity.this, EmployeeCardBrowserActivity.class);
                startActivity(mIntent);
            }
        });
        ...
        btn_fingerprintsearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mIntent = new Intent(VerificationModeTaskActivity.this, TaskAllocationIdentifyFingerprints.class);
                startActivity(mIntent);
            }
        });
    ...
    private class LogOut extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(VerificationModeTaskActivity.this,
        ...
        protected String doInBackground(Void... params) {
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(VerificationModeTaskActivity.this);
