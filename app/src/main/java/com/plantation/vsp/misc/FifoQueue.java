...
package com.plantation.vsp.misc;
...
public class FifoQueue {
    ...
    private final StringBuilder mBufferData = new StringBuilder();
     ...
     *
     * @param value the data to be appended in the buffer
     */
     ...
     *
     * @param dest                      the object to store the data read
     * @param maxDataToBeReadFromBuffer the maximum data to read from the buffer
     * @return the total number of characters read
     */
     ...
     *
     * @param dest      the object to append the data read
     * @param searchFor the string to search the buffer for
     * @return the total number of characters read
     */
