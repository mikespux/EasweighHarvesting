...
import com.plantation.activities.ScaleEasyWeighBioActivity;
...
public class EasyWeighBioService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG, "ScaleEasyWeighBioActivity Service is running.");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
            ...
            deviceAddress = b.getString(ScaleEasyWeighBioActivity.EXTRA_DEVICE_ADDRESS);
            scaleVersion = b.getString(ScaleEasyWeighBioActivity.SCALE_VERSION);
    ...
    private synchronized void setState(int state) {
        ...
        //mHandler.obtainMessage(ScaleEasyWeighBioActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
        Message msg = Message.obtain(null, ScaleEasyWeighBioActivity.MESSAGE_STATE_CHANGE, state, -1);
        tumaMessage(msg);
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        //Message msg = mHandler.obtainMessage(ScaleEasyWeighBioActivity.MESSAGE_DEVICE_NAME);
        Message msg = Message.obtain(null, ScaleEasyWeighBioActivity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(ScaleEasyWeighBioActivity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
        tumaMessage(msg);
        ...
        new Thread("WeighingThread") {
            ...
            public void run() {
                try {
                    //get scale version
                    if (scaleVersion.equals(ScaleEasyWeighBioActivity.EASYWEIGH_VERSION_11)) {
                    ...
                    } else if (scaleVersion.equals(ScaleEasyWeighBioActivity.EASYWEIGH_VERSION_15)) {
                        //  sending R to get readings from BT Scale
                        while (true) {
                            String message = "R";
                            byte[] send = message.getBytes();
    ...
    public synchronized void stop() {
        ...
        connectionFailed();
        EasyWeighBioService.this.stopSelf();
    }
    ...
    private void connectionFailed() {
        ...
        //Message msg = mHandler.obtainMessage(ScaleEasyWeighBioActivity.MESSAGE_TOAST);
        Message msg = Message.obtain(null, ScaleEasyWeighBioActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(ScaleEasyWeighBioActivity.TOAST, "Unable to connect scale");
        msg.setData(bundle);
        tumaMessage(msg);
        //mHandler.sendMessage(msg);

        // Start the service over to restart listening mode
        EasyWeighBioService.this.start();
    }
    ...
    private void connectionLost() {
        ...
        Message msg = Message.obtain(null, ScaleEasyWeighBioActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(ScaleEasyWeighBioActivity.TOAST, "Scale Disconnected");
        msg.setData(bundle);
        tumaMessage(msg);
    ...
    /**
     * Constructor. Prepares a new ScaleEasyWeighBioActivity session.
     *
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_REG_CLIENT:
                    ...
                    Log.i(TAG, "Got Address [" + ScaleEasyWeighBioActivity.getAddress() + "]");
                    //String deviceAddress = ScaleEasyWeighBioActivity.getAddress().toString();
                    ...
                    if (deviceAddress != null && deviceAddress.length() > 0) { //Check if we have a valid bluetooth Mac Address
                        try {//Attempting to connect using got address
                            ...
                            if (mState != STATE_CONNECTED) {
                                mDevice = mBluetoothAdapter.getRemoteDevice(ScaleEasyWeighBioActivity.getAddress());
                        ...
                        try {
                            Message msg2 = Message.obtain(null, ScaleEasyWeighBioActivity.REQUEST_DEVICEADDRESS);
                            tumaMessage(msg2);
                        } catch (Exception e2) {
                ...
                case RETRY:
                    try {
                        ...
                        deviceAddress = msg.getData().getString(ScaleEasyWeighBioActivity.EXTRA_DEVICE_ADDRESS);
                ...
                case RECONNECT:
                    ...
                    if (deviceAddress.equals("") || deviceAddress.equals(null)) {
                        //Complete failure
                        Message totalFailure = Message.obtain(null, ScaleEasyWeighBioActivity.COMPLETE_FAILURE);
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            synchronized (EasyWeighBioService.this) {
                mConnectThread = null;
            }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
					...
					/*mHandler.obtainMessage(ScaleEasyWeighBioActivity.MESSAGE_READ, bytes, -1, buffer)
					.sendToTarget();*/
                    Message msg = Message.obtain(null, ScaleEasyWeighBioActivity.MESSAGE_READ, bytes, -1, buffer);
                    tumaMessage(msg);
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                Message msg = null;
                if (readingProbed) {
                    msg = Message.obtain(null, ScaleEasyWeighBioActivity.READING_PROBE, -1, -1, buffer);
                } else {
                    msg = Message.obtain(null, ScaleEasyWeighBioActivity.MESSAGE_WRITE, -1, -1, buffer);
                }
