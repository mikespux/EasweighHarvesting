...
public class BothCardWeighActivity extends AppCompatActivity {
    ...
    private TextView mTextView, tv_number, textAccountId; //ECP 2017-01-16

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_both_card_weigh);
        ...
        prefs = PreferenceManager.getDefaultSharedPreferences(BothCardWeighActivity.this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                ca.setFilterQueryProvider(constraint -> {
                    ...
                    return dbhelper.SearchSpecificEmployee(EmployeeNo);
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                ca.setFilterQueryProvider(constraint -> {
                    String EmployeeNo = constraint.toString();
                    return dbhelper.SearchEmployee(EmployeeNo);
            ...
            if (tagN != null) {
                ...
                if (accounts.getCount() > 0) {
                    ...
                    while (accounts.moveToNext()) {
                        ...
                        Toast.makeText(BothCardWeighActivity.this, "EmployeeNO:" + FpEmployeeNo, Toast.LENGTH_LONG).show();
