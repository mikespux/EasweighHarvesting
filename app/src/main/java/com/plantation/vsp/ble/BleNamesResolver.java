...
public abstract class BleNamesResolver {
    private static final HashMap<String, String> mServices = new HashMap<String, String>();
    private static final HashMap<String, String> mCharacteristics = new HashMap<String, String>();
    private static final SparseArray<String> mValueFormats = new SparseArray<String>();
    private static final SparseArray<String> mAppearance = new SparseArray<String>();
    private static final SparseArray<String> mHeartRateSensorLocation = new SparseArray<String>();
