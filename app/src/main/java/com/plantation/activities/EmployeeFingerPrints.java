...
import com.plantation.fingerprintreader.FingerView;
...
public class EmployeeFingerPrints extends AppCompatActivity implements View.OnClickListener {
    ...
    String s_femID, s_femPickerNo, s_emFingerNo, s_emFingerprint;
    String accountId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ltIdentify = findViewById(R.id.ltIdentify);
        ltIdentify.setVisibility(View.VISIBLE);
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            closeDevice();
            finish();
            Intent mIntent = new Intent(EmployeeFingerPrints.this, SettingsActivity.class);
...
//        fi.convert2Wsq();
    ...
    private void openDevice() {
        new Thread() {
            @Override
            public void run() {
                synchronized (EmployeeFingerPrints.this) {
                    ...
                    if ((error = Bione.initialize(EmployeeFingerPrints.this, FP_DB_PATH)) != Bione.RESULT_OK) {
                ...
                if (params[0].equals("enroll")) {
                    ...
                    /*switch(FingerNo){
                        case 1:
                            ...
                            s_emFingerNo="1";
                            mId = id;
                            s_emFingerprint=Base64.encodeToString(fpTemp, Base64.DEFAULT);
                            dbhelper.AddFP(s_femID, s_femPickerNo, s_emFingerNo,String.valueOf(mId),s_emFingerprint);



                            byte []mMatData = Base64.decode(s_emFingerprint, Base64.DEFAULT);
                            break;
                        case 2:
                            s_femID = prefs.getString("EmployeeNo","");
                            s_emName = prefs.getString("EmployeeName","");
